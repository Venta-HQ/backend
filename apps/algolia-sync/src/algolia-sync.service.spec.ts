  ...
  describe('Event Handling', () => {
    ...
    describe('vendor.created', () => {
      it('should handle vendor created event successfully', async () => {
        ...
        await eventHandler({ type: 'vendor.created', data: vendorData });
      ...
      it('should handle algolia service errors gracefully', async () => {
        ...
        await expect(eventHandler({ type: 'vendor.created', data: vendorData })).resolves.not.toThrow();
      });
    });
    ...
    describe('vendor.updated', () => {
      it('should handle vendor updated event successfully', async () => {
        ...
        await eventHandler({ type: 'vendor.updated', data: vendorData });
      ...
      it('should handle algolia service errors gracefully', async () => {
        ...
        await expect(eventHandler({ type: 'vendor.updated', data: vendorData })).resolves.not.toThrow();
      });
    });
    ...
    describe('vendor.deleted', () => {
      it('should handle vendor deleted event successfully', async () => {
        ...
        await eventHandler({ type: 'vendor.deleted', data: vendorData });
      ...
      it('should handle algolia service errors gracefully', async () => {
        ...
        await expect(eventHandler({ type: 'vendor.deleted', data: vendorData })).resolves.not.toThrow();
      });
    });
    ...
    describe('vendor.location.updated', () => {
      it('should handle vendor location updated event successfully', async () => {
        ...
        await eventHandler({ type: 'vendor.location.updated', data: locationData });
      ...
      it('should handle algolia service errors gracefully', async () => {
        ...
        await expect(eventHandler({ type: 'vendor.location.updated', data: locationData })).resolves.not.toThrow();
      });
    });

    describe('unknown event types', () => {
      it('should ignore unknown event types', async () => {
        const unknownEvent = { type: 'vendor.unknown', data: {} };
